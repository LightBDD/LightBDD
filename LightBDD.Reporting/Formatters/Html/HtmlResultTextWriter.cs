...
namespace LightBDD.Reporting.Formatters.Html
{
    internal class HtmlResultTextWriter : IDisposable
    {
        ...
        private readonly string _styles = ReadResource("LightBDD.Reporting.Formatters.Html.styles.css");
        private readonly string _scripts = ReadResource("LightBDD.Reporting.Formatters.Html.scripts.js");
        private readonly string _favico = ReadBase64Resource("LightBDD.Reporting.Formatters.Html.lightbdd_small.ico");
