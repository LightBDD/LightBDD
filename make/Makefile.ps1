...
Define-Step -Name 'Build VSIX package' -Target 'all,pack' -Body {
    call "msbuild.exe" templates\LightBDD.VSIXTemplates.sln /tv:16.0 /t:"Clean,Build" /p:Configuration=Release /m /verbosity:m /nologo /p:TreatWarningsAsErrors=true /nr:false
