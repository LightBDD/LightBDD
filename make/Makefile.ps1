Define-Step -Name 'Update version' -Target 'all,build' -Body {
    ...
    Get-ChildItem '.\templates' 'ProjectTemplate.csproj' -Recurse | %{
        Replace-InFile $_.FullName $version 'Include="LightBDD.Fixie3" Version="%"','Include="LightBDD.NUnit2" Version="%"','Include="LightBDD.NUnit3" Version="%"','Include="LightBDD.XUnit2" Version="%"','Include="LightBDD.XUnit3" Version="%"','Include="LightBDD.MsTest3" Version="%"','Include="LightBDD.MsTest4" Version="%"','Include="LightBDD.TUnit" Version="%"'
    }
}
