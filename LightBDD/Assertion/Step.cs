...
{
    /// <summary>
    /// Step class, allowing to control step execution.
    /// </summary>
    public static class Step
    {
        /// <summary>
        /// Bypasses step being currently executed and continues execution of current scenario, allowing to execute all remaining steps.
