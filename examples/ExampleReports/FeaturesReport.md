...
| Entry              | Value |
|              ----: | :---- |
| Execution Start    | 2025-01-05 20:09:09 UTC |
| Execution Duration | 6s 086ms |
...
### :red_circle: Scenario: Adding contacts :watch:`55ms`
> This scenario presents failures captured by VerifiableTree

#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN an empty address book :watch:`2ms`
...
#### &nbsp;&nbsp;&nbsp; :red_circle: Step 4: THEN address book should contain contacts "`<$contacts>`❗" :watch:`6ms`
**$contacts**:
<div style="overflow-x: auto;">
...
### :white_check_mark: Scenario: Persisting address book :watch:`62ms`
...
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 2: WHEN I persist book as json :watch:`18ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 3: THEN address book should match persisted json "`<$json>`☑" :watch:`3ms`
**$json**:
<div style="overflow-x: auto;">
...
### :white_check_mark: Scenario: No product in stock :label:`Ticket-6` :file_folder:`Sales` :watch:`1s 545ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN product is out of stock :watch:`5ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 2: WHEN customer adds it to the basket :watch:`1s 522ms`
...
### :warning: Scenario: Successful addition :label:`Ticket-7` :file_folder:`Sales` :watch:`1s 294ms`
> This scenario presents how LightBDD reports ignored steps

#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN product is in stock :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 2: WHEN customer adds it to the basket :watch:`1s 293ms`
...
### :red_circle: Scenario: Adding numbers :label:`Ticket-13` :watch:`49ms`
> This scenario presents usage of Verifiable<T> and MultiAssertAttribute

#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN a calculator :watch:`2ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 2: THEN adding "`2`" to "`3`" should give "`5`☑" :watch:`3ms`
#### &nbsp;&nbsp;&nbsp; :red_circle: Step 3: AND adding "`-3`" to "`2`" should give "`expected: equals '-1', but got: '1'`❗" :watch:`22ms`
...
### :red_circle: Scenario: Composite operations :label:`Ticket-13` :watch:`16ms`
> This scenario presents behavior of MultiAssertAttribute

#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN a calculator :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :red_circle: Step 2: THEN it should add numbers :watch:`5ms`
...
### :red_circle: Scenario: Dividing numbers :label:`Ticket-13` :watch:`4ms`
> This scenario presents usage of Verifiable<T> and MultiAssertAttribute
...
### :white_check_mark: Scenario: Adding numbers :watch:`28ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN calculator :watch:`5ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 2: WHEN I add two numbers :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 3: THEN I should get an expected result :watch:`5ms`
---
...
### :white_check_mark: Scenario: Contact book should allow me to add multiple contacts :label:`Ticket-8` :watch:`31ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN my contact book is empty :watch:`5ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 2: WHEN I add new contacts :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 3: THEN all contacts should be available in the contact book :watch:`7ms`
---


### :large_blue_diamond: Scenario: Contact book should allow me to remove all contacts :label:`Ticket-9` :watch:`24ms`
> This scenario presents how LightBDD reports bypassed steps

#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN my contact book is filled with many contacts :watch:`19ms`
#### &nbsp;&nbsp;&nbsp; :large_blue_diamond: Step 2: WHEN I clear it :watch:`2ms`
...
### :white_check_mark: Scenario: Displaying contacts alphabetically :watch:`32ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN my contact book is empty :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 2: AND I added contacts "`<$contacts>`" :watch:`17ms`
**$contacts**:
<div style="overflow-x: auto;">
...
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 4: THEN I should receive contacts "`<$contacts>`☑" :watch:`9ms`
**$contacts**:
<div style="overflow-x: auto;">
...
### :red_circle: Scenario: Normalizing contact details :watch:`10ms`
...
#### &nbsp;&nbsp;&nbsp; :red_circle: Step 3: THEN I should receive contacts "`<$contacts>`❗" :watch:`5ms`
**$contacts**:
<div style="overflow-x: auto;">
...
### :red_circle: Scenario: Searching for contacts by phone :watch:`14ms`
> This scenario presents failures captured by VerifiableTree
...
#### &nbsp;&nbsp;&nbsp; :red_circle: Step 4: THEN I should receive contacts "`<$contacts>`❗" :watch:`6ms`
**$contacts**:
<div style="overflow-x: auto;">
...
### :warning: Scenario: Ordering products :label:`Ticket-12` :watch:`4s 624ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN customer is logged in :watch:`1s 079ms`
...
#### &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :white_check_mark: Step 1.4: WHEN the user clicks login button :watch:`1s 070ms`
#### &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :white_check_mark: Step 1.5: THEN the login operation should be successful :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :large_blue_diamond: Step 2: WHEN customer adds products to basket :watch:`1s 528ms`
#### &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :white_check_mark: Step 2.1: GIVEN product "`wooden desk`" is in stock :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :large_blue_diamond: Step 2.2: WHEN customer adds product "`wooden desk`" to the basket :watch:`1s 525ms`
#### &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :white_check_mark: Step 2.3: THEN the product addition should be successful :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 3: AND customer pays for products in basket :watch:`1s 997ms`
#### &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :white_check_mark: Step 3.1: WHEN customer requests to pay :watch:`1s 994ms`
...
> [!NOTE]
> Step 4.1: [:link: invoice-content](33c9c685-d17d-4751-a903-238571fc8f12.txt)
...
### :white_check_mark: Scenario: Displaying home page in "`DE`" :watch:`7ms`
...
### :white_check_mark: Scenario: Displaying home page in "`EN`" :watch:`26ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN a customer with "`EN`" language selected :watch:`4ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 2: WHEN the customer opens the home page :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 3: THEN header should display "`EN`" language :watch:`2ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 4: AND page title should be translated :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 5: AND all menu items should be translated :watch:`<1ms`
---
...
### :warning: Scenario: Receiving invoice for products :label:`Ticket-4` :file_folder:`Sales` :watch:`27ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN product "`wooden desk`" is available in product storage :watch:`2ms`
...
### :white_check_mark: Scenario: Browsing invoices :label:`Ticket-14` :watch:`4s 729ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN invoice "`Invoice-1`" :watch:`1s 686ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 2: AND invoice "`Invoice-2`" :watch:`1s 685ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 3: WHEN I request all historical invoices :watch:`1s 342ms`
...
### :red_circle: Scenario: Anonymous login name should allow to log in :label:`Ticket-3` :file_folder:`Security` :watch:`1s 431ms`
> This scenario presents how LightBDD reports failed steps

#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN the user is about to login :watch:`5ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 2: AND the user entered anonymous login :watch:`1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 3: WHEN the user clicks login button :watch:`1s 397ms`
...
### :white_check_mark: Scenario: Successful login :label:`Ticket-1` :file_folder:`Security` :watch:`1s 485ms`
...
### :white_check_mark: Scenario: Wrong login provided causes login to fail :label:`Ticket-2` :file_folder:`Security` :watch:`1s 575ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN the user is about to login :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 2: AND the user entered invalid login :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 3: AND the user entered valid password :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 4: WHEN the user clicks login button :watch:`1s 574ms`
...
### :white_check_mark: Scenario: Wrong password provided causes login to fail :label:`Ticket-2` :file_folder:`Security` :watch:`1s 215ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN the user is about to login :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 2: AND the user entered valid login :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 3: AND the user entered invalid password :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 4: WHEN the user clicks login button :watch:`1s 214ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 5: THEN the login operation should be unsuccessful :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 6: AND an invalid login or password error message should be returned :watch:`<1ms`
---
...
### :white_check_mark: Scenario: Successful payment :label:`Ticket-10``Ticket-11` :watch:`6s 086ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN customer has some products in basket :watch:`1s 407ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 2: AND customer has enough money to pay for products :watch:`1s 044ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 3: WHEN customer requests to pay :watch:`1s 840ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 4: THEN payment should be successful :watch:`1s 779ms`
---
...
### :white_check_mark: Scenario: Should dispatch product after payment is finalized :label:`Ticket-5` :file_folder:`Delivery``Sales` :watch:`24ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN There is an active customer with id "`ABC-123`" :watch:`3ms`
...
### :red_circle: Scenario: Saving data :watch:`2s 080ms`
> This scenario presents failures captured by VerifiableTree using ExpectEquivalent mode

#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN no saved records :watch:`4ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 2: WHEN I save records "`<$records>`" :watch:`2s 052ms`
**$records**:
<div style="overflow-x: auto;">
...
### :red_circle: Scenario: Retrieving user details :watch:`52ms`
...
#### &nbsp;&nbsp;&nbsp; :red_circle: Step 3: THEN I should receive user with id "`124`☑" name "`expected: equals 'Joe', but got: 'JOE'`❗" surname "`expected: equals 'Johnson', but got: 'JOHNSON'`❗" and email "`jj@gmail.com`☑" :watch:`29ms`
> [!IMPORTANT]
> <pre>
...
### :red_circle: Scenario: User search :watch:`24ms`
> This scenario presents failures captured by VerifiableTable

#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN users "`<$users>`" :watch:`9ms`
**$users**:
<div style="overflow-x: auto;">
...
### :red_circle: Scenario: Validating found users :watch:`9ms`
...
#### &nbsp;&nbsp;&nbsp; :red_circle: Step 3: THEN I should receive users "`<$users>`❗" :watch:`5ms`
**$users**:
<div style="overflow-x: auto;">
...
### :white_check_mark: Scenario: Validating user details :watch:`6ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 1: GIVEN a user with id "`124`" name "`Joe`" surname "`Johnson`" and email "`jj@gmail.com`" :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 2: WHEN I request user details for id "`124`" :watch:`<1ms`
#### &nbsp;&nbsp;&nbsp; :white_check_mark: Step 3: THEN I should receive user with id "`124`☑" name "`JOE`☑" surname "`JOHNSON`☑" and email "`jj@gmail.com`☑" :watch:`3ms`
---
