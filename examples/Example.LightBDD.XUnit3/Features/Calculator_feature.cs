...
namespace Example.LightBDD.XUnit3.Features
{
    /// <summary>
...
This example presents usage of MultiAssertAttribute.")]
    public partial class Calculator_feature
    {
        ...
        public void Multiplying_numbers()
        {
            Runner.RunScenario(
                _ => Given_a_calculator(),
                _ => Then_multiplying_X_to_Y_should_give_RESULT(6, 2, 12),
                _ => Then_multiplying_X_to_Y_should_give_RESULT(-1, 2, -2),
                _ => Then_multiplying_X_to_Y_should_give_RESULT(2, 0, 0),
                _ => Then_multiplying_X_to_Y_should_give_RESULT(2, 3, 6),
                _ => Then_multiplying_X_to_Y_should_give_RESULT(2, -3, -6));
        }
        ...
        private CompositeStep Then_it_should_divide_numbers()
        {
            return CompositeStep.DefineNew().AddSteps(
                ...
                _ => Then_multiplying_X_to_Y_should_give_RESULT(5, 2, 2))
            .Build();
        }
        ...
        private CompositeStep Then_it_should_multiply_numbers()
        {
            ...
            return CompositeStep.DefineNew().AddSteps(
                    _ => Then_multiplying_X_to_Y_should_give_RESULT(2, 3, 6),
                    _ => Then_multiplying_X_to_Y_should_give_RESULT(2, -3, -6),
                    _ => Then_multiplying_X_to_Y_should_give_RESULT(1, 1, 1))
                .Build();
        }
