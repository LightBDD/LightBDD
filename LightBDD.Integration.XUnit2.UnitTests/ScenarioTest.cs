using System;
using LightBDD.Integration.XUnit2.UnitTests.Helpers;
using Xunit;
...
{
    [Scenario]
    public void Ignored () { StepExecution.Current.IgnoreScenario(""reason""); }
}
";
...
public class TestClass
{
    ...
    [InlineData(0)]
    [InlineData(1)]
    public void IsZero (int arg) { if(arg!=0) StepExecution.Current.IgnoreScenario(""reason""); }
}
";
