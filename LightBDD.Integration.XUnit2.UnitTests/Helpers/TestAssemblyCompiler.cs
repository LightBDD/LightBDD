...
namespace LightBDD.Integration.XUnit2.UnitTests.Helpers
{
    internal static class TestAssemblyCompiler
    {
        public static string Compile(string code)
        {
            ...
            parameters.ReferencedAssemblies.Add("LightBDD.Core.dll");
            parameters.ReferencedAssemblies.Add("LightBDD.Integration.XUnit2.dll");
