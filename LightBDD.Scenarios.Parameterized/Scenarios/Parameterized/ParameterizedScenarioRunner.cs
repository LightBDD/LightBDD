...
{
    internal class ParameterizedScenarioRunner<TContext> : IParameterizedScenarioRunner<TContext>
    {
        private readonly IBddRunner<TContext> _runner;

        public ParameterizedScenarioRunner(IBddRunner<TContext> runner)
        {
            _runner = runner;
        }
