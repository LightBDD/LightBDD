...
{
    /// <summary>
    /// Class providing implementation of <see cref="IProgressNotifier"/> which is designed to provide notifications that would be still understandable when scenarios are executed in parallel.
