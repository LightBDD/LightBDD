...
namespace LightBDD.Fixie3
{
    ...
    public static class StepExecutionExtensions
    {
        ...
        /// The currently executed step as well as scenario status becomes <see cref="ExecutionStatus.Ignored"/> in LightBDD reports, while test itself would be marked as 'Skipped' in Fixie.
        /// </summary>
