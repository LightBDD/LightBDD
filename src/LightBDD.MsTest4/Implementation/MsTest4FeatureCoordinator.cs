...
{
    internal class MsTest4FeatureCoordinator : FrameworkFeatureCoordinator
    {
        ...
        private MsTest4FeatureCoordinator(LightBddConfiguration configuration)
        ...
        {
            return new DefaultIntegrationContext(configuration, new MsTest4MetadataProvider(configuration), MapExceptionToStatus);
        }

        internal static void InstallSelf(LightBddConfiguration configuration)
        {
            Install(new MsTest4FeatureCoordinator(configuration));
        }
