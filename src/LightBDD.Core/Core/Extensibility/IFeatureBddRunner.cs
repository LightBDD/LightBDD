...
namespace LightBDD.Core.Extensibility
{
    ...
    /// The instances of this interface can be provided by <see cref="FeatureBddRunnerFactory"/>.
    ...
    public interface IFeatureBddRunner : IDisposable
    {
        ...
        /// <exception cref="ArgumentException">Throws when <paramref name="fixture"/> type does not match feature type that <see cref="IFeatureBddRunner"/> has been created for by <see cref="FeatureBddRunnerFactory"/>.</exception>
