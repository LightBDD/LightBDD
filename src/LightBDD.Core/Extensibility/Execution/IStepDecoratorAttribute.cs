...
namespace LightBDD.Core.Extensibility.Execution
{
    ...
    /// Decorators will be executed in order specified by <see cref="IOrderedAttribute.Order"/> property, after globally registered step decorators with <see cref="ExecutionExtensionsConfiguration"/>.
    /// </summary>
