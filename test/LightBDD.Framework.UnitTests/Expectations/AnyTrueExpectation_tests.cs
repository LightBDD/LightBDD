...
namespace LightBDD.Framework.UnitTests.Expectations
{
    ...
    public class AnyTrueExpectation_tests
    {
        ...
        {
            var expectation = Expect.To.AnyTrue(x => x.LessThan(2), x => x.GreaterThan(5), x => x.Equal(4));
        ...
        {
            var expectation = Expect.To.Not.AnyTrue(x => x.LessThan(2), x => x.GreaterThan(5), x => x.Equal(4));
            Assert.True(expectation.Verify(3, ValueFormattingServices.Current));
        }

        [Test]
        [TestCase(3, "expected: (less than '2' or greater than '5' or equal '4'), but got: '3'\n\texpected: less than '2', but got: '3'\n\texpected: greater than '5', but got: '3'\n\texpected: equal '4', but got: '3'")]
        ...
        [Test]
        [TestCase(4, "expected: not (less than '2' or greater than '5' or equal '4'), but it was")]
        [TestCase(1, "expected: not (less than '2' or greater than '5' or equal '4'), but it was")]
        [TestCase(6, "expected: not (less than '2' or greater than '5' or equal '4'), but it was")]
        ...
        {
            Assert.That(Expect.To.AnyTrue(x => x.LessThan(2), x => x.GreaterThan(5), x => x.Equal(4)).ToString(), Is.EqualTo("(less than '2' or greater than '5' or equal '4')"));
        }
    }
}