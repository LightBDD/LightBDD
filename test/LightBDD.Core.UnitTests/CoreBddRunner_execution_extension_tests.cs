...
namespace LightBDD.Core.UnitTests
{
    ...
    public class CoreBddRunner_execution_extension_tests
    {
        ...
        public void It_should_propagate_exception_thrown_from_step_extension_with_simple_stack_trace()
        {
            ...
            ex.AssertStackTraceMatching(@"^\s*at LightBDD.Core.UnitTests.CoreBddRunner_execution_extension_tests.MyThrowingDecorator.ProcessStatus\s*\(\)[^\n]*
\s*at LightBDD.Core.UnitTests.CoreBddRunner_execution_extension_tests.MyThrowingDecorator.ExecuteAsync\s*\(IStep step, Func`1 stepInvocation\)[^\n]*
...
([^\n]*
)?\s*at LightBDD.UnitTests.Helpers.TestableIntegration.TestSyntaxRunner.TestScenario\s*\(IEnumerable`1 steps\)[^\n]*");
        }
...
([^\n]*
        ...
        public void It_should_propagate_exception_thrown_from_scenario_extension_with_simple_stack_trace()
        {
            ...
            ex.AssertStackTraceMatching(@"^\s*at LightBDD.Core.UnitTests.CoreBddRunner_execution_extension_tests.MyThrowingDecorator.ProcessStatus\s*\(\)[^\n]*
   at LightBDD.Core.UnitTests.CoreBddRunner_execution_extension_tests.MyThrowingDecorator.ExecuteAsync\s*\(IScenario scenario, Func`1 scenarioInvocation\)[^\n]*
