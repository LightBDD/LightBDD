...
namespace LightBDD.UnitTests.Helpers.TestableIntegration
{
    ...
    {
        public static StepDescriptor CreateAsync(Action step) => new StepDescriptor(step.GetMethodInfo(),
            async (ctx, args) =>
            {
                await Task.Delay(10);
                step.Invoke();
        ...
        public static StepDescriptor CreateSync(Action step) => new StepDescriptor(step.GetMethodInfo(),
            (ctx, args) =>
            {
                step.Invoke();
        ...
        public static StepDescriptor Create(Func<Task> step) => new StepDescriptor(step.GetMethodInfo(), (ctx, args) =>
            {
                step.Invoke();
                return Task.FromResult(DefaultStepResultDescriptor.Instance);
            });
        ...
        public static StepDescriptor CreateWithTypeAsync(string stepType, Action step) => new StepDescriptor(
            step.GetMethodInfo(),
            async (ctx, args) =>
            {
                await Task.Yield();
