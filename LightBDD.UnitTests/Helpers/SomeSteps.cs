...
namespace LightBDD.UnitTests.Helpers
{
    public class SomeSteps
    {
        ...
        public void Step_with_comment(string comment) { StepExecution.Comment(comment); }
        public void Step_with_comments() { StepExecution.Comment("comment one"); StepExecution.CommentFormat("comment {0}", 2); }
